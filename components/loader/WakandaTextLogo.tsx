...
const WakandaTextLogoComponent = () => {
  return (
    <svg
      className="w-44 h-16"
    ...
    >
      <g>
        <g className="green-text-drop-shadow" filter="url(#filter_G02BFL3GN)">
          <g fill="#fff">
...
export const WakandaTextLogo = React.memo(WakandaTextLogoComponent);
